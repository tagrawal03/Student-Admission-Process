...
int main (void)
{
  ...
  int addlen, addlenUdp ,numbytes, udpnumbytes;
  ...
  printf("Student 1 has ip address: %s", inet_ntoa(myaddr.sin_addr));
  ...
  //printf("Student1: UDP - waiting to recieve from ...");      
  ...
  cout <<"Student 1 has recieved the reply from Admission office"<<endl;
  ...
  stufile.open("Student1_result.txt");
  stufile << data <<endl;
  ...
  printf("Student1 has ip address: %s", inet_ntoa(myaddr.sin_addr));
  printf(" and UDP port number: %d for phase 2\n", (int) ntohs(myaddrUdp.sin_port));

  printf("Student 1 has recieved application result '%s' \n", data);
  cout << "End of phase 2 for Student 1"<<endl;
  cout <<'\n'<<endl;
