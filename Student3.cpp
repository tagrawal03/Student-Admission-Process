...
int main (void)
{
  ...
  printf("Student 3 has ip address: %s", inet_ntoa(myaddr.sin_addr));
  ...
  cout <<"Student 3 has recieved the reply from Admission office"<<endl;
  ...
  stufile.open("Student3_result.txt");
  stufile << data <<endl;
  ...
  printf("Student3 has ip address: %s", inet_ntoa(myaddr.sin_addr));
  printf(" and UDP port number: %d for phase 2\n", (int) ntohs(myaddrUdp.sin_port));

  printf("Student 3 has recieved application result '%s' \n", data);
  cout << "End of phase 2 for Student 3"<<endl;
  cout <<'\n'<<endl;
